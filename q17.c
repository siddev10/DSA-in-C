// 17.	Implement following collision handling techniques for hash table                                      Linear probing 
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <stdbool.h>
...
int main() {
    printf("=== QUESTION 17: Linear Probing Hash Table ===\n");
    ...
    while (1) {
        ...
        switch (choice) {
            case 1:
                ...
                scanf("%d", &key);
                insertLinearProbing(ht, key);
                break;
                
            case 2:
                printf("Enter key to search: ");
                scanf("%d", &key);
                int result = searchLinearProbing(ht, key);
                if (result != -1) {
